<?php
/**
 * Netzknoten Controller
 * Steuert die Logik für Netzknoten-Modell Operationen
 */

require_once __DIR__ . '/../model/Project.php';
require_once __DIR__ . '/../model/Image.php';

class NetzknotenController {
    ...
    public function index() {
        ...
        // View laden
        require_once __DIR__ . '/../view/netzknoten/index.php';
    }
    ...
    public function showProjectOverview() {
        ...
        require_once __DIR__ . '/../view/netzknoten/overview.php';
    }
