 ...
 * Steuert die Logik für Abschnittsbewertung Operationen
 */

require_once __DIR__ . '/../model/Project.php';
require_once __DIR__ . '/../model/Image.php';

class AbschnittController {
    ...
    public function index() {
        ...
        // View laden
        require_once __DIR__ . '/../view/abschnitt/index.php';
    }
    ...
    public function showProjectOverview() {
        ...
        require_once __DIR__ . '/../view/abschnitt/overview.php';
    }
