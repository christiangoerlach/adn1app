...
<div class="content">
    ...
    <div id="projekt-content">
        <?php 
        // Inkludiere index_netzknoten.php für die Netzknoten-Statistiken
        $indexNetzknotenPath = __DIR__ . '/../../../index_netzknoten.php';
        if (file_exists($indexNetzknotenPath)) {
            // Fehlerbehandlung für include
            try {
                include $indexNetzknotenPath;
            } catch (Exception $e) {
                error_log('Fehler beim Laden von index_netzknoten.php: ' . $e->getMessage());
